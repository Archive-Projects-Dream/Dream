...
///sent to TTS sounds when the volume of their mixer channel (CHANNEL_VOICES) is changed in the volume mixer
#define COMSIG_MOB_TTS_VOLUME_PREFERENCE_APPLIED "tts_volume_preference_applied"

///sent to radio TTS sounds when the volume of their mixer channel (CHANNEL_RADIO) is changed in the volume mixer
