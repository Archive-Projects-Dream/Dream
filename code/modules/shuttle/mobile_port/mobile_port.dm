...
/obj/docking_port/mobile/proc/hyperspace_sound(phase, list/areas)
	...
	for(var/mob/zlevel_mobs as anything in SSmobs.clients_by_zlevel[z])
		...
		if(dist_far <= long_range && dist_far > range)
			zlevel_mobs.playsound_local(distant_source, "sound/runtime/hyperspace/[selected_sound]_distance.ogg", 100, channel = CHANNEL_SHUTTLES) // [HORIZON-EDIT] Master_Sounds
			...
			zlevel_mobs.playsound_local(source, "sound/runtime/hyperspace/[selected_sound].ogg", 100, channel = CHANNEL_SHUTTLES) // [HORIZON-EDIT] Master_Sounds
